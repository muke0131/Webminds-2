  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div className="service-container">
        ...
        <p>
          Welcome to SimplePay! These terms of service ("Terms") govern your use of <br />SimplePay's website, services, and applications (collectively referred to as the<br /> "Service"). By accessing or using the Service, you agree to be bound by these<br /> Terms.<br /><br />
          ...
          2. Description of Service SimplePay provides a platform for users to make and <br />receive payments using the Unified Payments Interface (UPI). Our Service allows<br /> users to securely transfer funds between bank accounts using their UPI-enabled<br /> devices.<br /><br />
          ...
          7. Intellectual Property All content and materials available through the Service <br />are the property of SimplePay or its licensors and are protected by copyright and other <br />intellectual property laws.<br /><br />

          8. Limitation of Liability SimplePay is not liable for any damages arising out of <br />or related to your use of the Service, including but not limited to, lost profits, <br />lost data, or consequential damages.<br /><br />

          9. Changes to Terms SimplePay reserves the right to modify or update these terms <br />at any time without prior notice. Your continued use of the Service after any such<br /> changes constitutes acceptance of the revised Terms.<br /><br />

          10. Termination SimplePay may terminate or suspend your access to the Service<br /> at any time, with or without cause, and without prior notice.<br /><br />
          ...
          12. Contact Us If you have any questions about these Terms, please contact us at<br /> upi@gmail.com.<br /><br />
